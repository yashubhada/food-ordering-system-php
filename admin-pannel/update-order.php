        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <?php
                ...
                $sql3 = "SELECT * FROM tbl_order WHERE order_id = $order_id";
            ...
            ?>
              ...
              <div class="row d-flex justify-content-center">
                <!-- Basic Layout -->
                <div class="col-md-6">
                  <form action="update-set-order.php" method="POST">
                    <div class="card mb-4">
                      <h5 class="card-header">Edit Order</h5>
                      <input type="hidden" class="form-control" name="o_id" value="<?php echo $row['order_id']; ?>">
                      <div class="card-body demo-vertical-spacing demo-only-element">
                        ...
                        <div class="input-group">
                          <span class="input-group-text" id="basic-addon11">Qty</span>
                          <input
                            type="number"
                            class="form-control"
                            name="food_qty"
                        ...
                        <div class="input-group">
                          ...
                          <select class="form-select" id="inputGroupSelect01" name="status">
                            ...
                            <option <?php if($row['status']=="OnDelivaery"){echo "selected";} ?> value="OnDelivaery">On Delivaery</option>
                            <option <?php if($row['status']=="Delevered"){echo "selected";} ?> value="Delevered">Delevered</option>
                        ...
                        <div class="form-password-toggle">
                          <label class="form-label" for="basic-default-password12">Customer Email</label>
                          <div class="input-group">
                            <input
                              type="email"
                              class="form-control"
                        ...
                        <div class="form-password-toggle">
                          <label class="form-label" for="basic-default-password12">Customer Contact</label>
                          <div class="input-group">
                            <input
                              type="text"
                              class="form-control"
                              name="customer_contact"
                              value="<?php echo $row['customer_contact']; ?>"
                              required
                            />
                          </div>
                        </div>
                        <div class="form-password-toggle">
                          ...
                          <div class="input-group">
                            <textarea class="form-control" rows="5" required name="customer_address" aria-label="With textarea"><?php echo $row['customer_address']; ?></textarea>
                          </div>
                        </div>
