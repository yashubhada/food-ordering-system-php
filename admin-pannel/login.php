        ...
        <div class="authentication-inner">
            ...
            <?php
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    $sql1 = "SELECT id, username, admin_role FROM admin WHERE username = '$username' AND password = '$password'";
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                <div class="mb-3">
