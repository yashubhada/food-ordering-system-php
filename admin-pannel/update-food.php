          ...
          <div class="content-wrapper">
            ...
            <?php
                ...
                $sql2 = "SELECT * FROM food
                        LEFT JOIN category ON food.category_id = category.id WHERE food.food_id = $food_id";

                $result2 = mysqli_query($conn, $sql2) or die("Query faild to update food");
            ...
            ?>
              ...
              <div class="row d-flex justify-content-center">
                <!-- Basic Layout -->
                <div class="col-md-6">
                  <form action="update-set-food.php" method="POST" enctype="multipart/form-data">
                    <div class="card mb-4">
                      <h5 class="card-header">Edit Food Item</h5>
                      <input type="hidden" class="form-control" name="food_id" value="<?php echo $row['food_id']; ?>">
                      <div class="card-body demo-vertical-spacing demo-only-element">
                        <div class="input-group">
                          <span class="input-group-text" id="basic-addon11"><i class="fa-solid fa-bowl-rice"></i></span>
                          <input
                            type="text"
                            class="form-control"
                            name="food_name"
                            ...
                            <?php
                                ...
                                if(mysqli_num_rows($result1) > 0)
                                {
                                    while($row1 = mysqli_fetch_assoc($result1))
                                    {
                                        ...
                                        ?>
                                            <option <?php echo $selected; ?> value="<?php echo $row1['id']; ?>"><?php echo $row1['category_name']; ?></option>
                                        <?php
                                    }
                                }
                            ?>
                        ...
                        <div class="form-password-toggle">
                          <label class="form-label" for="basic-default-password12">Food Description</label>
                          <div class="input-group">
                            <textarea class="form-control" rows="5" required name="food_desc" aria-label="With textarea"><?php echo $row['description']; ?></textarea>
                          </div>
                        </div>
                        <div class="input-group">
                        ...
                        <div class="form-password-toggle">
                          <label class="form-label" for="basic-default-password12">Upload Food Image</label>
                          <div class="input-group">
                            <input type="file" class="form-control" name="new-image" id="inputGroupFile02" />
                            <input type="hidden" name="old-image" value="<?php echo $row['image_name']; ?>">
                          </div>
                          <img class="mt-2" src="upload/<?php echo $row['image_name']; ?>" height="100px" alt="food image">
                        </div>
