          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <?php
                    ...
                    $sql1 = "SELECT * FROM tbl_order ORDER BY order_id DESC";
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        ...
                                        {
                                            echo "<span class='badge bg-label-primary me-1'>".$row['status']."</span>";
                                        }
                                        elseif($row['status'] == "OnDelivaery")
                                        {
                                            echo "<span class='badge bg-label-warning me-1'>".$row['status']."</span>";
                                        }
                                        elseif($row['status'] == "Delevered")
                                        {
                                            echo "<span class='badge bg-label-success me-1'>".$row['status']."</span>";
                                        }
                                        elseif($row['status'] == "Cancelled")
                                        {
                                            echo "<span class='badge bg-label-danger me-1'>".$row['status']."</span>";
                                        }
                                    ?>
                                </td>
                                ...
                                <td><?php echo substr($row['customer_address'], 0, 30) . "..." ?></td>
                                <td>
                                  <a href="update-order.php?id=<?php echo $row['order_id']; ?>">
