                    ...
                    <table class="table">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="upload/<?php echo $row['image_name']; ?>" width="100px" alt="food image"></td>
                                ...
                                <td>
                                  <div class="dropdown">
                                      ...
                                      <a class="dropdown-item" href="update-food.php?id=<?php echo $row['food_id']; ?>"
                                          ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                      >
                                      <a class="dropdown-item" href="delete-food.php?id=<?php echo $row['food_id']; ?>&catid=<?php echo $row['category_id']; ?>"
