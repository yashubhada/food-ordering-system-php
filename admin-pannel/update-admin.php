          ...
          <div class="content-wrapper">
            ...
            <?php
                ...
                // get id from manage-admin page
                  ...
                  $sql3 = "SELECT * FROM admin WHERE id = $get_id";
              ...
              <div class="row d-flex justify-content-center">
                <!-- Basic Layout -->
                <div class="col-md-6">
                  <form action="update-set-admin.php" method="POST">
                    <div class="card mb-4">
                      <h5 class="card-header">Edit Admin</h5>
                      <div class="card-body demo-vertical-spacing demo-only-element">
                      <input type="hidden" name="a_id" value="<?php echo $row['id']; ?>">
                      <div class="input-group">
                          <span class="input-group-text" id="basic-addon11"><i class="menu-icon tf-icons bx bx-user"></i></span>
                          <input
                            type="text"
                            class="form-control"
                            name="full_name"
                        ...
                        <div class="input-group">
                          <label class="input-group-text" for="inputGroupSelect01">Admin Role</label>
                          <select class="form-select" id="inputGroupSelect01" name="role" value="<?php echo $row['admin_role']; ?>">
                            <?php 
                                if($row['admin_role'] == 1)
                                {
                                ?>
                                ...
                                {
                                ?>
                                    <option value="0" selected>Normal Admin</option>
              ...
              <?php
                    ...
                    else
                    {
                        echo '<div class="alert alert-danger alert-dismissible" role="alert">
                                You are not authorized to Edit admin
