                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        if($row['admin_role'] == 1)
                                        {
                                            echo '<span class="badge bg-label-primary me-1">Super Admin</span>';
                                        }
                                        else
                                        {
                                            echo '<span class="badge bg-label-warning me-1">Normal Admin</span>';
                                        }
                                    ?>
                                </td>
                                <td>
                                  <div class="dropdown">
                                      ...
                                      <a class="dropdown-item" href="update-admin.php?id=<?php echo $row['id']; ?>"
                                          ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                      >
                                      <a class="dropdown-item" href="delete-admin.php?id=<?php echo $row['id']; ?>"
